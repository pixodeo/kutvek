...
<article class="item">
	...
	<aside class="item-cart" id="p-cart">	
		...
		<footer>				
			...
			<form action="<?= $this->url('sportswear.addToCart', ['fqdn' => 1, 'queries'=>[]], 'POST'); ?>" method="post" id="addToCart" data-ctrl="appareal.addToCart" >	
				...
				<input type="hidden" name="item[item_custom][size][id]" id="size-id" value="" />	
				<input type="hidden" name="item[item_custom][size][name]" id="size-name"  value="" />
				<p class="cart-action">
