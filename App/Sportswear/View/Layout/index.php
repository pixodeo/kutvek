<!DOCTYPE html>
<html lang="<?=$this->getLang();?>" data-layout="sportswear">
<head>
	<!-- Google Tag Manager -->
	...
	<style>
		...
		.section-title {margin-top: 0;font-weight: 500;}
		...
		.accordion_tabs li {height: 2.4rem;line-height: 2.4rem;}
		...
		.main-footer .logo-footer {display:block;height: 4.2rem; margin:0 auto;}
