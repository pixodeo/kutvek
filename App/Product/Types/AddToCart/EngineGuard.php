 ...
 */
final class EngineGuard extends Type {  
	...
	//$version = $this->data['item']['skid_plates_version'];    
		$designation = <<<EOT
		{$this->data['item']['description']} {$this->data['item']['skid_plates_version']}
		EOT;
