...
<div class="item-content">
	...
	<ul class="tabs grid" id="item-info">
		<li class="col-6 active"><a href="#desc-info">Description</a></li>		
		<li class="col-6 "><a href="#avis-info"><span data-i18n="customer-review">Avis client</span></a></li>
	</ul>
...
<aside class="item-cart" id="p-cart">	
	...
	<div class="items">
		<p id="p-<?= $this->product->id; ?>">
			...
			<input type="hidden" name="item[item_price][product]" id="price-opts" form="addToCart" value="<?=$this->product->amount;?>" />
			<input type="hidden" name="item[item_price][opts]" id="price-opts" form="addToCart" value="0" />
			<input type="hidden" name="item[item_price][accessories]" id="price-accessories" form="addToCart" value="0" />	
