...
<div>
	...
	<div class="col-s-12 col-l-6"><div class="field-wrapper column"><label for="race-number">Numéro de course</label><input name="item[item_custom][opts][plate][raceNumber]" id="race-number" type="text" class="field-input" form="addToCart" data-i18n="race-number" required></div></div>
</div>
<div class="item-content">
			
	<pre>
		<?php if(isset($_GET['dev'])) print_r($this->product); ?>
	</pre>
</div>
