<!DOCTYPE html>
<html lang="<?=$this->getLang();?>" data-layout="thanks" data-analytics="<?=$this->url('checkout.analytics.purchase');?>">
<head>
	<!-- Google Tag Manager -->
...
<body>
	...
	<script type="module">
		import analytics from "<?= $this->auto_version('/js/modules/analytics.js') ?>";
