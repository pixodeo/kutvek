<!DOCTYPE html>
<html lang="<?= $this->app->getLang(); ?>" data-layout="licenses">
...
<body>
	...
	<?php foreach (['vehicles', 'families', 'designs', 'colors', 'brands'] as $filter): ?>
		<aside class="modal click filters-modal" id="<?= $filter; ?>" data-modal="<?= $filter; ?>" data-ctrl="app.modal">
			<div class="popup mx-w45 widget-filter">
				<header class="close">
	...
	<?php endforeach; ?>
	<script type="module" src="<?= $this->auto_version('/js/licenses.js') ?>"></script>	
	<script src="<?= $this->auto_version('/js/front/filter-licensed.js') ?>"></script>
