<!DOCTYPE html>
<html lang="<?= $this->app->getLang(); ?>" data-layout="login">
...
<head>
	...
	<link rel="stylesheet" href="<?= $this->auto_version('/css/front/basic-header.css') ?>" type="text/css" media="screen">
