<section class="row">
	<div class="col-s-12 col-l-9 col-l-center">
		<div class="widget-custom empty"></div>
		<div class="row">
							...
							<div class="title accordion_tabs">
								...
								<ul>
									...
									<li class="field-wrapper checkbox">							
										<input name="family[]" type="checkbox" class="field-input onchange" value="<?=$f_k;?>" data-i18n="family" id="family-<?= $f_k;?>">
						...
						<div class="widget-filter">
							<div class="title accordion_tabs">
								...
								<ul>						
									...
									<li class="field-wrapper checkbox">							
										<input name="category[]" type="checkbox" class="field-input onchange" value="<?=$k;?>" data-i18n="category" id="category-<?= $k;?>" >
