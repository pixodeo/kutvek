		...
		<form class="bloc-widgets-filter filter-form" id="filters-form">
			<div class="widget-filter">
				<div class="title accordion_tabs">
					...
					<input type="checkbox" id="vehicle" class="filter" data-uri="<?= $this->uri('products.filters', ['queries' => ['filter' => 'vehicle', 'slug' => $current_slug, 'depth' => $depth]]); ?>" data-modal="vehicles" data-onload="1" />
