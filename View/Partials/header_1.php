...
<div class="french-days">        
    <?php if($this->_i18nId == 3): ?>

            <b class="frdays"> FRENCH DAYS 
                <span class="flag"></span>
            </b> : <span><b>-20€</b> dès 170€ d'achat : </span> <span class="blue">FRDAYS20</span><span> / <b>-40€</b> dès 320€ d'achat : </span><span class="blue">FRDAYS40</span><span> / <b>-60€</b> dès 450€ d'achat : </span> <span class="blue">FRDAYS60</span>
        
        <!-- <span class="red">INFO livraison  : </span> En raison d'un surcroît d'activité le délai de livraison pour les commandes avec personnalisation est de <span class="red">10 jours ouvrés</span>.   -->  
    <?php else: ?>
       <!--  <span class="red">INFO delivery : </span> Due to increased activity, the delivery time for orders with cutomization is currently <span class="red">10 working days</span>. -->
    <?php endif; ?>        
</div>