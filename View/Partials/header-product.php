    ...
    <div class="infos">
       ...
       <div>
            ...
            <div class="action trads-container">
                <?= $this->widgetProductI18ns($slugs); ?>
            </div>
            <?= $this->widgetCountryCurrencySelector(); ?>
       </div>
   </div>
    <div class="baseline">
        <a href="<?= $this->uri('pages.index', []) ?>" class="logo"><img class="logo-kutvek" src="<?= HALLOWEEN === 1 ? '/img/charter/logo_kutvek_orange.png' : '/img/charter/logo-kutvek.png';?>" alt="Logo KUTVEK"></a>
        <div class="red">
