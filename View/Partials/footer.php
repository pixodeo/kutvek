...
?>
<aside class="modal click" id="promo-info-2" data-modal="promo-info" data-ctrl="popin.close">   
    <div class="popin img">
        <header class="close">            
            <a href="#promo-info" class="click" data-modal="promo-info" data-ctrl="popin.close"><span class="icon material-symbols-rounded">close</span></a>
        </header>
        <div class="content">
            <picture>                       
