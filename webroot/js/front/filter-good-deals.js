const filter = {
	...
	createCard: function (card) {
		...
		const price = clone.querySelector('span.price.stroke');
		const price_sale = clone.querySelector('span.price.sale');
		...
		price.textContent = card.price_f;
		price_sale.textContent = card.sale_price;
