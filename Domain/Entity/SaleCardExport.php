...
class SaleCardExport extends Entity {
	public $designation;
	...
	public function content(){
		...
		$this->designation = $this->full_designation;
		if($this->item_slug === null) $this->item_slug = $this->slugify($this->full_designation);
		if($this->behavior === 5) $this->description = $this->df_description;
